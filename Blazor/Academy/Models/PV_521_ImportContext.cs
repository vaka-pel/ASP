...
public partial class PV_521_ImportContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Date).HasName("PK__DaysOFF__D9DE21FCC09413F2");
        ...
        {
            entity.HasKey(e => e.HolidayId).HasName("PK__Holidays__253884EAC18BB4F5");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Salary__ED1FC9EAE7D92737");
